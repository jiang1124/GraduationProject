package com.example.shoppingsystem.View;
...
public class PayWayDialog extends Dialog implements View.OnClickListener {
    ...
    public PayWayDialog(Context context, int layoutRes, int[] clickIds) {
    ...
    public PayWayDialog(Activity mActivity, View view, int[] clickIds) {
    ...
    public interface OnBottomItemClickListener {
        void onBottomItemClick(PayWayDialog payWayDialog, View view);
    }
