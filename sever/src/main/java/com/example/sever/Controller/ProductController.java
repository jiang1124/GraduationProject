...
public class ProductController {
    ...
    public List<Product> storeSearchProducts(int store_id,String key,int page){
        return productService.findStoreProducts(store_id,key,page);
    }
    ...
    public String updateProduct(int product_id, String product_name,double product_price,double product_favl,double extra_money,String type,String detail){
        return productService.updateProduct(product_id, product_name, product_price, product_favl, extra_money, type,detail);
    }
    ...
    public String addProduct(int store_id, String product_name,double product_price,double product_favl,double extra_money,String type,String detail){
        return productService.addProduct(store_id, product_name, product_price, product_favl, extra_money, type,detail);
    }
